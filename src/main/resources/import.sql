...
insert into user (username, password, fullname, enabled, role_id, fbid) values ('jedrzej', '$2a$06$CzXAK3icLkBnpgi5zOTB.O/jzZqnxbPhtUQaxGZOhedahxAV2Iy4K','Jędrzej K.',true, 1, 1327256238);
