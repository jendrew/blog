...
insert into user (username, password, fullname, enabled, role_id, fbid) values ('jedrzej', '$2a$10$rsTfl7aSS4hWztBcpGBfLu4HJUP5Fb0bQqneXvQntJO6eowlomStu',true, 0, 1327256238);
